...
public class BookService {
    ...
    Because updating a book is just like creating book but without a new Id.
    ...
    //  Integer because it is a primitive class
    public Book deleteBook(int bookId) {
        ...
        Link 2 : https://www.baeldung.com/exception-handling-for-rest-with-spring
           We shoud change the error response manually 
         */
